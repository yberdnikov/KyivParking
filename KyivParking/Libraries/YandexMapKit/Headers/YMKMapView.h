...
/**
 @abstract The current user location. 
 @discussion You can track user location either by KVO via userLocation.location key path 
 or by using YMKMapViewDelegate's mapView:didUpdateUserLocation:
 */
...
/**
 Scrolls Map so correspond annotation becomes visible.
