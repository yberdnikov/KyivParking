 ...
 */
- (void)mapView:(YMKMapView *)mapView locationManagerDidReceiveError:(NSError *)error;

/**
 Tells the delegate that the location of the user was updated.
 @discussion While the showsUserLocation property is set to YES, this method is called whenever a new location 
 update is received by the map view.
 @param The map view that is tracking the user’s location.
 @param The location object representing the user’s latest location.
 */
 ...
 */
- (void)mapView:(YMKMapView *)mapView gotTapAndHoldAtCoordinate:(YMKMapCoordinate)coordinate;
